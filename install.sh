#!/usr/bin/env sh
# Universal installer for clearancepath. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/clearancepath.git"
echo "Installing clearancepath ..."
...
echo "Done. Run: clearancepath --help"
