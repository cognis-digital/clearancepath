"""Native cognis-connect emit for clearancepath — forward findings to any platform.

Maps clearancepath's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    clearancepath ... --format json | clearancepath-emit --to stix
    clearancepath-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
